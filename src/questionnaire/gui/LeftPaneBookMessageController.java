            ...
            if(lText.getParent() != null) {
                if(imageHeight != 0 && imageWidth / imageHeight > 1 ) {
                    ...
                    */
                    ...
                    if(lHeader.getWidth() - tmpImageWidth - 48 > 0) {
                        lText.setPrefWidth(lHeader.getWidth() - tmpImageWidth - 48); // -48 = -8 (space between text & image) -20*2 (space for frame)
                    } else {
                        lText.setPrefWidth(100);
                    }
